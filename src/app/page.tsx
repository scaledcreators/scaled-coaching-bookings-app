  ...
  return (
    <main className="theme-root landing">
      <nav className="nav landing-nav">
        <Link className="brand" href="/">Scaled<span>Coaching</span></Link>
      ...
      <section className="feature-grid" aria-label="Product highlights">
        ...
        <article className="sc-card feature-card"><Sparkles /><h2>Concierge queue</h2><p>Approve the time, assign a coach, and add private meeting details in one calm workflow.</p></article>
